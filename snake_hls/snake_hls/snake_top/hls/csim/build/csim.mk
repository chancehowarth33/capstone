...
HLS_SOURCES = ../../../../../snake_tb.cpp ../../../../../snake.cpp
...
$(ObjDir)/snake_tb.o: ../../../../../snake_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../snake_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/snake_tb.d

$(ObjDir)/snake.o: ../../../../../snake.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../snake.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=snake_top $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/snake.d
